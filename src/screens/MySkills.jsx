    ...
    <section id='skills' className='pt-10 '>
        ...
        <motion.div 
              ...
              transition={{duration:0.5}} variants={{
                  ...
                  <div className='flex justify-center items-center shadow bg-deep-blue
                  p-4 shadow-lg shadow-cyan-500/50 w-20 h-20 my-2 '>
                      <img alt='node' src={require('../assets/C#.png')} className='w-10' />
                  </div>
                  <div className='flex justify-center items-center shadow bg-deep-blue
                  p-4 shadow-lg shadow-cyan-500/50 w-20 h-20 my-2'>
                      <img alt='node' src={require('../assets/EFCore.png')} className='w-10' />
                  </div>
                  <div className='flex justify-center items-center shadow bg-deep-blue
                  p-4 shadow-lg shadow-cyan-500/50 w-20 h-20 my-2'>
                ...
                <div className='md:flex md:justify-between mt-16 ml-0 gap-32 '>
                <motion.div 
                 className='md:w-4/5'
                initial="hidden" whileInView="visible" viewport={{once:true,amount:0.5}}
                transition={{duration:0.5}} variants={{
                    ...
                    <div className='relative h-32'>
                        ...
                        <div className='w-1/2 md:w-1/2 h-32 bg-red absolute right-0 top-0 z-[-1]
                            '>
                            <div className=' absolute flex justify-center inset-x-0 bottom-0 '>
                            <p className='font-playfair text-md '>.NET Developer Intern</p>
                            </div>
